...
export interface ApiCategoryForCategoryFor extends Schema.CollectionType {
...
export interface ApiRestaurantRestaurant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category_fors: Attribute.Relation<
      'api::restaurant.restaurant',
      'manyToMany',
      'api::category-for.category-for'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::category-for.category-for': ApiCategoryForCategoryFor;
